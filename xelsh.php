...
function openWin(id)
{
var con = confirm("დარწმუნებული ხართ რომ წაიშალოს ხელშეკრულება ?");
if(con)
{
...
<table width="877" height="27" border="0" align="center">
 ...
 <tr class="zoma_10">
     <td align="center" class="cxrili" width="23">ინფო</td>
    <td align="center" class="cxrili" width="95">სახელი</td>
    <td align="center" class="cxrili" width="114">გვარი</td>
    <td align="center" class="cxrili" width="134">პირადი #</td>
    <td align="center" class="cxrili" width="83">ტელეფონი</td>
    <td align="center" class="cxrili" width="97">პოზიცია</td>
    <td align="center" class="cxrili" width="66">ხელშეკრულება</td>
    <td align="center" class="cxrili" width="66">დანართი</td>
    <td align="center" class="cxrili" width="66">წაშლა</td>
	<td align="center" class="cxrili" width="91">რედაქტირება</td>
  </tr>
  <tr>
<?php 
    mysql_query("SET NAMES 'utf8'");
    $result = mysql_query("SELECT * FROM xelshekruleba ORDER BY id DESC LIMIT $start_from, 30");
...
?>
 <tr class='klientebi'>
    ...
    <td width='95' align='center'> <?php echo $saxeli ?> </td>
    <td width='114' align='center'> <?php echo $gvari ?> </td>
    <td width='134' align='center'> <?php echo $piradi ?> </td>
	<td width='83' align='center'> <?php echo $telefoni ?> </td>
	<td width='97' align='center'> <?php echo $dasaxeleba ?></td>
    <td width='66' align='center'><a href='print.php?id=<?php echo $id ?>'><img src='images/print.png'></a></td>
	<td width='66' align='center'><a href='danarti.php?id=<?php echo $id ?>'><img src='images/print.png'></a></td>
    <td width='66' align='center'><input type="image" src="images/delete.png" window onclick="openWin(<?php echo $id; ?>)"/></td>
	<td width='91' align='center'><a href='edit.php?id=<?php echo $id ?>'><img src='images/pencil.png'></a></td>
  </tr>
<?php
}
?>
...
<?php
   ...
   echo "<b>".$i."</b> ";
	...
	echo "<a href='xelsh.php?page=".$i."'>".$i."</a> ";
