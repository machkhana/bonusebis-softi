...
<table width="877" height="27" border="0" align="center">
 <tr>
   ...
   <a href="xelsh.php?page=1"><input name="" type="button" value="მთავარი" class="damateba" /></a>&nbsp;
...
$result = mysql_query("SELECT id,saxeli,gvari,piradi, pozicia, telefoni FROM xelshekruleba ORDER BY id DESC LIMIT $start_from, 30");
...
?>
 <tr class='klientebi'>
    <td width='2' align='center'><a href='view.php?id=<?php echo $id ?>'><img src='images/info.png'></a></td>
    ...
    <td width='70' align='center'><input type="image" src="images/delete.png" window onclick="openWin(<?php echo $id; ?>)"/></td>
...
echo "<b>".$i."</b> ";
	...
	echo "<a href='xelshtest.php?page=".$i."'>".$i."</a> ";
